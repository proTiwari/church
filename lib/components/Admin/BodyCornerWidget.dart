          ...
          actions: [
                              ...
                              return Center(
                                child: Text(
                                    ...
                                    style: primaryTextStyle(
                                        size:
                                            appStore.allUnreadCount > 99 ? 9 : 12,
            ...
            Tooltip(
              ...
              child: FlutterSwitch(
                ...
                borderRadius: 30.0,
                padding: 4.0,
                activeIcon: ImageIcon(AssetImage(ic_moon),
                    color: Colors.white, size: 30),
                inactiveIcon: ImageIcon(AssetImage(ic_sun),
                    color: Colors.white, size: 30),
            ...
            PopupMenuButton(
              padding: EdgeInsets.zero,
              child: Padding(
                padding: EdgeInsets.only(right: 16, top: 10, bottom: 6),
                child: Row(
                  children: [
                    Container(
                      height: 60,
        ...
        body: Container(
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                left:
                    appStore.selectedLanguage == 'ar' ? 0 : getMenuWidth() - 15,
                right:
                    appStore.selectedLanguage == 'ar' ? getMenuWidth() - 30 : 0,
