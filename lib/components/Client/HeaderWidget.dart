      ...
      child: Row(
        ...
        children: [
          ...
          if (!ResponsiveWidget.isSmallScreen(context))
            Text(value, style: primaryTextStyle(color: Colors.black, size: 14))
                .paddingTop(4),
        ],
      ),
    );
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                if (getJSONAsync(CITY_DATA).isNotEmpty &&
                    getStringAsync(USER_TYPE) == CLIENT)
                  mMenuItem(
                      Icons.location_on,
                      CityData.fromJson(getJSONAsync(CITY_DATA))
                          .name
                          .validate(), () async {
                    await showDialog(
                        context: context,
                ...
                if ((appStore.isLoggedIn &&
                  ...
                  PopupMenuButton(
                    ...
                    child: Row(
                      children: [
                        commonCachedNetworkImage(appStore.userProfile,
                                height: 40,
                                width: 40,
                                fit: BoxFit.cover,
                                alignment: Alignment.center)
