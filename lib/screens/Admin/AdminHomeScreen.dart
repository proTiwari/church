                ...
                FutureBuilder<DashboardModel>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      ...
                      monthlyOrderCount =
                          snapshot.data!.monthlyOrderCount ?? [];
                            ...
                            Wrap(
                              ...
                              children: [
                                ...
                                TotalUserWidget(
                                    ...
                                    totalCount: snapshot
                                        .data!.totalCourierAssignedOrder,
                                    image: 'assets/icons/ic_orders.png'),
                                TotalUserWidget(
                                ...
                                TotalUserWidget(
                                    ...
                                    totalCount: snapshot
                                        .data!.totalCourierPickedUpOrder,
                                    image: 'assets/icons/ic_orders.png'),
                                TotalUserWidget(
                                    title: language.departedOrder,
                                    totalCount: snapshot
                                        .data!.totalCourierDepartedOrder,
                                    image: 'assets/icons/ic_orders.png'),
                                TotalUserWidget(
                                    title: language.deliveredOrder,
                                    totalCount:
                                        snapshot.data!.totalCompletedOrder,
                                    image: 'assets/icons/ic_orders.png'),
                                TotalUserWidget(
                                    title: language.cancelledOrder,
                                    totalCount:
                                        snapshot.data!.totalCancelledOrder,
                                    image: 'assets/icons/ic_orders.png'),
                                TotalUserWidget(
