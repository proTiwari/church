...
import '../../components/Client/SignInComponent.dart';
import '../../main.dart';
      ...
      await getClientDashboard().then((value) {
        ...
        if (value.appSetting != null) {
          appStore.setCurrencyCode(
              value.appSetting!.currencyCode ?? defaultCurrencyCode);
          appStore.setCurrencySymbol(
              value.appSetting!.currency ?? defaultCurrencySymbol);
          appStore.setCurrencyPosition(
              value.appSetting!.currencyPosition ?? CURRENCY_POSITION_LEFT);
        }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: Container(
        decoration: boxDecorationWithRoundedCorners(
            backgroundColor: Colors.white, borderRadius: radius(40)),
        child: IconButton(
